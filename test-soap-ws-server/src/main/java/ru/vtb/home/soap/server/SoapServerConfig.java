...
//// We are going to receive async responses on the Client side
//    @Bean
...
//    }
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema schema){
        ...
        wsdl11Definition.setTargetNamespace("http://minishift.host/beer");
        wsdl11Definition.setSchema(schema);

        // fix for adding soap action to the dynamic generated wsdl
        Properties soapActions = new Properties();
        soapActions.setProperty("getBeer", "http://minishift.host/getBeerRequest");
